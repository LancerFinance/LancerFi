          ...
          <div className={`flex items-center space-x-2 ${connectedAddress ? 'ml-36' : 'ml-[100px]'}`}>
            ...
            >
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                <path d="M10.802 17.77a.703.703 0 11-.002 1.406.703.703 0 01.002-1.406m11.024-4.347a.703.703 0 11.001-1.406.703.703 0 01-.001 1.406m0-2.854a2.057 2.057 0 100 4.114 2.057 2.057 0 000-4.114M11.76 13.336a2.057 2.057 0 10.001 4.115 2.057 2.057 0 00-.001-4.115m0-1.336C7.485 12 4 15.485 4 19.76s3.485 7.76 7.76 7.76 7.76-3.485 7.76-7.76S16.035 12 11.76 12m0-1.336c4.789 0 8.76 3.97 8.76 8.76s-3.971 8.76-8.76 8.76S3 24.213 3 19.424s3.971-8.76 8.76-8.76M.24 19.302c-.132 0-.24.108-.24.24v4.177c0 .132.108.24.24.24h4.177c.132 0 .24-.108.24-.24v-4.177c0-.132-.108-.24-.24-.24H.24m1.336 1.336v1.505h1.505v-1.505H1.576m15.168-5.123a.703.703 0 110-1.406.703.703 0 010 1.406m-4.347-11.024a.703.703 0 11-.001 1.406.703.703 0 01.001-1.406m2.854 0a2.057 2.057 0 10.001 4.114 2.057 2.057 0 00-.001-4.114M12.424 0a2.057 2.057 0 100 4.115 2.057 2.057 0 000-4.115M12.24.76C16.515.76 20 4.245 20 8.52S16.515 16.28 12.24 16.28 4.48 12.795 4.48 8.52 7.965.76 12.24.76m0-1.336C7.451-.576 3.144 3.731 3.144 8.52c0 4.789 3.307 8.76 8.096 8.76 4.789 0 8.76-3.971 8.76-8.76C20 3.731 16.029-.576 12.24-.576M20.76 4.48c.132 0 .24-.108.24-.24V.063c0-.132-.108-.24-.24-.24h-4.177c-.132 0-.24.108-.24.24v4.177c0 .132.108.24.24.24h4.177m-1.336-1.336V1.639h-1.505v1.505h1.505"/>
              </svg>
            </a>
            <a 
