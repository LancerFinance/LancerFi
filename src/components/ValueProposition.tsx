      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {benefits.map((benefit, index) => (
            <Card 
              key={index} 
              className="bg-card border border-border hover-lift hover:shadow-lg fade-in"
            ...
            >
              <CardContent className="p-8">
                <div className="mb-6">
                  ...
                  <div className="inline-flex items-center px-3 py-1 bg-secondary rounded-md mb-4 border border-border">
        ...
        <div className="text-center mt-16 fade-in">
          <div className="bg-primary rounded-2xl p-12 text-center max-w-4xl mx-auto shadow-lg">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link 
                to="/post-project" 
                className="bg-background text-foreground px-10 py-4 rounded-lg font-bold text-base hover:bg-background/90 transition-colors ripple inline-flex items-center justify-center" 
                role="button" 
