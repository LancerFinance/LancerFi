-- Fix the calculate_freelancer_earnings function to avoid column ambiguity
...
-- Also fix the update_freelancer_stats function to use the corrected function name
